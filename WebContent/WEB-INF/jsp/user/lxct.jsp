...
<link href="${pageContext.request.contextPath }/assets/css/animate-custom.css" rel="stylesheet"> 
<script src="${pageContext.request.contextPath }/assets/js/jquery.min.js"></script>
<script type="${pageContext.request.contextPath }/text/javascript" src="assets/js/modernizr.custom.js"></script>
    ...
    <div class="container">
      ...
      <div class="navbar-header">
	   <div class="pull-left logo">
        <a class="" href="#home"><img src="${pageContext.request.contextPath }/assets/img/logo.png" /></a>
       </div>
        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
        </div>
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav pull-right">
          <li><a href="#home-section" class="smoothScroll">欢迎</a></li>
          <li> <a href="#services" class="smoothScroll">服务</a></li>		  
          <li> <a href="#about" class="smoothScroll"> 商店</a></li>
          <li> <a href="#portfolio" class="smoothScroll"> 招牌</a></li>
          <!-- <li> <a href="#team" class="smoothScroll"> 厨师</a></li> -->
...
<div id="headerwrap" name="home">
 ...
 <i class="fa fa-heart-o icon"></i>
    ...
    <a href="#portfolio" class="smoothScroll btn btn-lg">今日招牌推荐</a> 
	</div>
	</header>
</div>
...
<div id="services" name="services">
  <div class="container">
    <div class="row">
      <h2 class="centered">我们的菜单</h2>
      <hr>
      <div class="col-lg-8 col-lg-offset-2">
        <p class="large">领携不仅仅是工作的地方，也是您生活的地方，加入领携你值得拥有！</p>
      </div>
      <div class="col-lg-4 callout"> <i class="fa fa-cubes fa-3x"></i>
        <h3>咖啡</h3>
        <p>咖啡是用经过烘焙的咖啡豆制作出来的饮料，与可可、茶同为流行于世界的主要饮品。</p>
      </div>
            ...
            <div class="highlight tb">
                ...
                <div class="links tb-cell">
                    <div class="reservation-link">
                        <a href="#" class="btn reservation-btn">回到顶部</a> 
                    </div> 
                </div>
            </div>
        </div>
...
<div id="about" name="about">
  <div class="container">
    <div class="row white">
      ...
      <hr>
      <div class="col-md-6"> <img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/about/about1.jpg" align=""> </div>
      <div class="col-md-6">
        <h3>Who we are</h3>
  ...
  <div class="container">
    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-md-4 ">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/portfolio/folio01.jpg" alt="">
              <figcaption>
                <h5>Coco Cake</h5>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/portfolio/folio01-preview.jpg" alt=""></p>
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/portfolio/folio02.jpg" alt="">
              <figcaption>
                <h5>Green Tea</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/portfolio/folio03.jpg" alt="">
              <figcaption>
                <h5>Cappuccino</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
      ...
      <div class="row">
        <div class="col-md-4 ">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/portfolio/folio04.jpg" alt="">
              <figcaption>
                <h5>Green Tea</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/portfolio/folio05.jpg" alt="">
              <figcaption>
                <h5>Cookies</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="${pageContext.request.contextPath }/assets/img/portfolio/folio06.jpg" alt="">
              <figcaption>
                <h5>Cake</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
	  ...
	  <strong>欢迎使用本公司点餐系统</strong>
        ...
        <form id="contact" method="post" class="form" role="form">
          <div class="row">
            ...
            <div class="col-md-12 form-group">
              <input class="form-control" id="email" name="email" placeholder="电话" type="email" required />
            </div>
			 <div class="col-md-12 form-group">
              <textarea class="form-control" id="message" name="message" placeholder="请输入内容" rows="5"></textarea>             
              <button class="btn btn-lg pull-left" type="submit">发送</button>
            </div>
          </div>
