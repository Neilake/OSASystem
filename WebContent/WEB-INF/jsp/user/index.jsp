...
<body>
	<div class="all">
		...
		<div class="login_box">
			...
			<form action="${pageContext.request.contextPath }/user/userlogin.do" method="post" onsubmit="return checkName()&&checkPass()">
				<div class="input" style="margin-top: 20px;">
					用户：<input type="text" name="username" id="vip"
				...
				<div class="submit">
					...
					<a href="${pageContext.request.contextPath }/admin/TurnAdmin.do" style="float:right " >管理员登录</a>
				</div>
			</form>
